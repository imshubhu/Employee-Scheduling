                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    <li>
                                        <a href="main.html" class="fa-home active">Home</a>
                                    </li>
                                    <li>
                                        <a href="login.html" class="fa-users ">Login</a>
                                       
                                    <li>
                                        <a href="register.html" class="fa-cloud ">Registration</a>
                                        
                                    </li>
                                    <li>
                                        <a href="about.html" class="fa-th ">About Us</a>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="assets/img/img1.jpg" width="640" height="188" alt="" class="fl" /></div>
          ...
          <div class="clr"></div>
          <div class="img"><img src="assets/img/img2.jpg" width="640" height="188" alt="" class="fl" /></div>
          <div class="post_content">
            <p></p>
            <p class="spec"><a href="#" class="rm">Read more &raquo;</a></p>
          </div>
        ...
        <p class="pages"><small>Page 1 of 2</small> <span>1</span> <a href="#">2</a> <a href="#">&raquo;</a></p>
			...
			<div class="footer"><p><h1>© 2016 Employee Scheduling. All Rights Reserved | Design by APK</h1></p></div>
