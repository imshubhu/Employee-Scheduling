                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    <li>
                                        <a href="shubham.php" class="fa-home ">Home</a>
                                    </li>
									<li>
                                    ...
                                    <li>
                                        ...
                                        <a href="workdata.php" class="fa-copy active">Work Data</a>
...
<table align="center" width="600px" border="2" cellspacing="1" cellpadding="1">
					...
					<?php
							...
							while($row = mysql_fetch_assoc($result))
							{
								...
								echo "<td>".$row['projectt']."</td>";
								echo "<td>".$row['projectc']."</th>";
								echo "<td>".$row['projecti']."</td>";
								echo "<td>".$row['other']."</td>";
								
								echo "<td><a href='select.php'>  Select</a></td>";
								echo "</tr>";
							}		
						?>
