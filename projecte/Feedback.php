                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    <li>
                                        <a href="shubham.php" class="fa-home active">Home</a>
                                    </li>
									<li>
                                    ...
                                    <li>
                                        ...
                                        <a href="workdata.php" class="fa-copy ">Work Data</a>
                                        
                                    </li>
                                    <li>
                                        <a href="Feedback.php" class="fa-th">Give Feedback</a>
                                        
                                    </li>
									<li>
                                        <a href="communication1.php" class="fa-th">Communication</a>
	...
	<div id="contact" class="contact">
				...
				<div class="col-md-4 contact-left" style="margin-left:200px;margin-top:50px;">				
					<form action="feedback1.php" method="post" >
									...
									<input type="text" value="Mobile number" name="mobile" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile';}" required=""><br>
									<select name="subject">
									...
									<textarea type="text" value="Feedback" name="message"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Feedback...';}" required="">Feedback...</textarea>
