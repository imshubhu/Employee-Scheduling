...
<html lang="en">
    ...
    <body>
		...
		<li><a href="city.php">City Master</a></li>
									...
									<li>
                                        <a href="communication.php" class="fa-copy active">Communication</a>
                                    </li>
									<li>
                                        <a href="#" class="fa-home ">Work Data</a>
										<ul>
        
        <li><a href="workfile.php">Work File</a></li>
		<li><a href="companyd.php">Company Detail's</a></li>
		<li><a href="city.php">City Master</a></li>
...
<table align="center" width="600px" border="2" cellspacing="1" cellpadding="1">
					...
					<?php
							...
							while($row = mysql_fetch_assoc($result))
							{
								...
								echo "<td>".$row['query']."</th>";
								echo "<td>".$row['extrat']."</td>";
								
								
								echo "<td><a href='reply.php'>  Reply</a></td>";
								echo "</tr>";
							}		
						?>
