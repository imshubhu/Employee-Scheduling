                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="register.php" class="fa-copy active">Registration</a>
							  ...
							  <div class="card"></div>
								...
								<form method="POST" action="registration1.php">
								  ...
								  <div>
									...
									<label for="Country"><h1 align="left">Country</h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php
								  ...
								  <div>
									<label for="State"><h1 align="left">State</h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php
								  ...
								  <div >
									...
									<label for="City" ><h1 align="left">City</h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php
